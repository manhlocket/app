...
const ASSETS = ['./', './index.html', './style.css', './app.js?v=33', './manifest.webmanifest', './icons/icon-192.png', './icons/icon-512.png', './icons/apple-touch-icon.png', './assets/apple-intelligence-reference.png', ...SPRITES];
